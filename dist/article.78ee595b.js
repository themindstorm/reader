...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/article.js":[function(require,module,exports) {
...
let articleUrl = document.location.href.split('#')[1]; // link to original article
...
async function fetchArticle(url) {
  ...
  return new Promise((resolve, reject) => {
    fetch('/api/content/' + escapedArticleUrl).then(response => {
...
function setContent(articleJson) {
  ...
  $datePublished.innerText = articleJson.date_published; // make css normal
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/article.js"], null)
//# sourceMappingURL=/article.78ee595b.js.map